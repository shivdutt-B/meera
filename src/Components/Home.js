...
function Home(props) {
  ...
  //   ContextItems.setProducts(fetch.data.products)
  // }
  ...
  // useEffect(() => {
  //   console.log('running...', ContextItems.cart)
  //   ContextItems.setProgress(50)
  //   fetchProducts()
  //   ContextItems.setProgress(100)
  //   ContextItems.fetchProducts(ContextItems.setProducts)
  //   setCart(ContextItems.cart)
  // }, [])
  ...
  // useEffect(() => {
    // console.log('CODE 23', ContextItems.products)
  // })
  ...
  return (
    ...
    <div className="main">
      <div className="gutter">
              ...
              <li className="category-list-item">
                <Link onClick={(e) => { transferProductCategory(e) }} to="/furniture" className="category-item-link" data-category="furniture&home-decoration">
                  ...
                  {/* <div className="hidden-options">
                    <ul className="hidden-options-list">
                      <li className="hidden-list-item">
                        <a href="#" className="hidden-list-link">Bedroom</a>
                      </li>
                      <li className="hidden-list-item">
                        <a href="#" className="hidden-list-link">Hall</a>
                      </li>
                      <li className="hidden-list-item">
                        <a href="#" className="hidden-list-link">Home Decor</a>
                      </li>
                      <li className="hidden-list-item">
                        <a href="#" className="hidden-list-link">Kitchen</a>
                      </li>
                      <li className="hidden-list-item">
                        <a href="#" className="hidden-list-link">Living Room</a>
                      </li>
                      <li className="hidden-list-item">
                        <a href="#" className="hidden-list-link">Work Space</a>
                      </li>
                    </ul>
                  </div> */}
                </Link>
                ...
                <Link onClick={(e) => { transferProductCategory(e) }} to="/kitchen" className="category-item-link" data-category="kitchen-accessories">
                  ...
                  {/* <div className="hidden-options">
                    <ul className="hidden-options-list">
                      ...
                      <li className="hidden-list-item">
                        <a href="#" className="hidden-list-link">Tools</a>
                      </li>
                      <li className="hidden-list-item">
                        <a href="#" className="hidden-list-link">Bedroom</a>
                      </li>
                      <li className="hidden-list-item">
                        <a href="#" className="hidden-list-link">Essentials</a>
                      </li>
                    </ul>
                  </div> */}
        ...
        {/* <div className="jewelry-skin-men-women-fragrance">
          <div className="j-s-m-w-f-first">
            <Link to="products" className="jewelry-container" data-category="jewelry" onClick={(e) => { transferProductCategory(e) }}>
              <div className="jewelry">
                <div className="jewelry-poster">
                  <img src={ProductJewelry} alt="" />
                </div>
            ...
            <Link to="products" className="skin-container" data-category="skincare" onClick={(e) => { transferProductCategory(e) }}>
              <div className="skin">
                <div className="skin-poster">
                  <img src={ProductSkinCare} alt="" />
                </div>
            ...
            <Link to="products" className="men-cloths-container" data-category="men's clothing" onClick={(e) => { transferProductCategory(e) }}>
              <div className="men-cloths">
                <div className="men-cloths-poster">
                  <img src={ProductMenCloths} alt="" />
                </div>
            ...
            <Link to="products" className="women-cloths-container" data-category="women's clothing" onClick={(e) => { transferProductCategory(e) }}>
              <div className="women-cloths">
                <img src={ProductWomenCloths} alt="" />
              </div>
              <div className="women-cloths-heading">
